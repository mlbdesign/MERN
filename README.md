This project is a MERN application  with an API REST Build with NodeJS, Mongoose and Express JS for the BackEnd side, and a React application for the Front end side.
